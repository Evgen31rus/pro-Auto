...
export default function Modal(){
    ...
    return(
        <div className={`${!isOpenModal? 'translate-x-[-250%] translate-y-[250%]': 'translate-x-[0%] translate-y-[-50%]'} tansition-all duration-300 flex-col h-[80vh] max-h-[500px] w-[40%] max-w-[400px] z-[60] bg-white fixed m-auto top-[50%] sm:w-[90%]  sm:h-[80vh] sm:max-h-[90vh]  `}>
